...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="PaymentezSDK",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
IB_DESIGNABLE
SWIFT_CLASS("_TtC12PaymentezSDK23MaskedTextFieldDelegate")
...
@interface MaskedTextFieldDelegate (SWIFT_EXTENSION(PaymentezSDK))
...
SWIFT_PROTOCOL("_TtP12PaymentezSDK31MaskedTextFieldDelegateListener_")
...
@property (nonatomic, strong) id <PaymentezCardAddedDelegate> _Nullable addDelegate;
...
SWIFT_PROTOCOL("_TtP12PaymentezSDK26PaymentezCardAddedDelegate_")
@protocol PaymentezCardAddedDelegate
- (void)cardAdded:(PaymentezSDKError * _Nullable)error :(PaymentezCard * _Nullable)cardAdded;
- (void)viewClosed;
@end
...
+ (void)add:(PaymentezCard * _Nonnull)card uid:(NSString * _Nonnull)uid email:(NSString * _Nonnull)email callback:(void (^ _Nonnull)(PaymentezSDKError * _Nullable, PaymentezCard * _Nullable))callback;
+ (void)scanCard:(UIViewController * _Nonnull)presenterViewController callback:(void (^ _Nonnull)(BOOL, NSString * _Nullable, NSString * _Nullable, NSString * _Nullable, PaymentezCard * _Nullable))callback;
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
/// Might be used as a decorator, which forwards UITextFieldDelegate calls to its own listener.
IB_DESIGNABLE
SWIFT_CLASS("_TtC12PaymentezSDK25PolyMaskTextFieldDelegate")
...
@interface UINavigationController (SWIFT_EXTENSION(PaymentezSDK))
- (void)pushPaymentezViewControllerWithDelegate:(id <PaymentezCardAddedDelegate> _Nonnull)delegate uid:(NSString * _Nonnull)uid email:(NSString * _Nonnull)email;
@end
...
@interface UIViewController (SWIFT_EXTENSION(PaymentezSDK))
- (PaymentezAddNativeViewController * _Nonnull)addPaymentezWidgetToView:(UIView * _Nonnull)containerView delegate:(id <PaymentezCardAddedDelegate> _Nullable)delegate uid:(NSString * _Nonnull)uid email:(NSString * _Nonnull)email SWIFT_WARN_UNUSED_RESULT;
- (void)presentPaymentezViewControllerWithDelegate:(id <PaymentezCardAddedDelegate> _Nonnull)delegate uid:(NSString * _Nonnull)uid email:(NSString * _Nonnull)email;
@end
