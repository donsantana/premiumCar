...
struct _R: Rswift.Validatable {
  ...
  struct nib: Rswift.Validatable {
    ...
    struct _ContactoCell: Rswift.NibResourceType {
      let bundle = R.hostingBundle
    ...
    struct _DestinoCell: Rswift.NibResourceType, Rswift.Validatable {
      ...
      static func validate() throws {
        if UIKit.UIImage(named: "mapIcon", in: R.hostingBundle, compatibleWith: nil) == nil { throw Rswift.ValidationError(description: "[R.swift] Image named 'mapIcon' is used in nib 'DestinoCell', but couldn't be loaded.") }
        if #available(iOS 11.0, tvOS 11.0, *) {
        }
      }
    ...
    struct _OfertaDataCell: Rswift.NibResourceType {
      let bundle = R.hostingBundle
    ...
    struct _OrigenCell: Rswift.NibResourceType {
      let bundle = R.hostingBundle
      let name = "OrigenCell"
    ...
    struct _PactadaCell: Rswift.NibResourceType, Rswift.Validatable {
      ...
      static func validate() throws {
        if UIKit.UIImage(named: "voucher", in: R.hostingBundle, compatibleWith: nil) == nil { throw Rswift.ValidationError(description: "[R.swift] Image named 'voucher' is used in nib 'PactadaCell', but couldn't be loaded.") }
        if #available(iOS 11.0, tvOS 11.0, *) {
        }
      }
    ...
    struct _VoucherCell: Rswift.NibResourceType, Rswift.Validatable {
      let bundle = R.hostingBundle
      ...
      static func validate() throws {
        if UIKit.UIImage(named: "bill", in: R.hostingBundle, compatibleWith: nil) == nil { throw Rswift.ValidationError(description: "[R.swift] Image named 'bill' is used in nib 'VoucherCell', but couldn't be loaded.") }
        if #available(iOS 11.0, tvOS 11.0, *) {
        }
      }
