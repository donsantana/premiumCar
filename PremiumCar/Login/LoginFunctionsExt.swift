...
extension LoginController{
  ...
  func initClientData(datos: [String: Any]){
    ...
    globalVariables.appConfig = globalVariables.userDefaults.value(forKey: "config") != nil ? AppConfig(config: globalVariables.userDefaults.value(forKey: "config") as! [String: Any]) : AppConfig()
