...
//  var urlFoto = ""
  ...
  func DatosSolicitud(id: Int, fechaHora: String, dirOrigen: String, referenciaOrigen: String, dirDestino: String, latOrigen: Double, lngOrigen: Double, latDestino: Double, lngDestino: Double, valorOferta: Double, detalleOferta: String, fechaReserva: String, useVoucher: String,tipoServicio: Int){
    self.id = id
